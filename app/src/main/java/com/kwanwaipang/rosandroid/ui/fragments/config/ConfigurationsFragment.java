package com.kwanwaipang.rosandroid.ui.fragments.config;
...
import com.kwanwaipang.rosandroid.ui.fragments.AboutFragment;
import com.kwanwaipang.rosandroid.viewmodel.ConfigurationsViewModel;
...
public class ConfigurationsFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        addConfigButton = view.findViewById(R.id.add_config_button); //增加配置的按钮在此
...
//        aboutButton.setOnClickListener(v -> fragment = new AboutFragment());
